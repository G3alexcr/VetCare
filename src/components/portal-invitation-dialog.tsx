...
💉 Carnet digital de vacunas y desparasitación
...
_Solo ingresa con tu correo_ *${client.email || "registrado"}*, _crea tu contraseña y verás todo el expediente de ${petName} al instante. ¡Es gratis!_
